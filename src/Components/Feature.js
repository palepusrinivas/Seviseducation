...
import { Briefcase, ClipboardList, Calendar } from "lucide-react"; // Importing relevant icons
...
<section className="relative overflow-hidden">
  ...
  <div className="absolute inset-0 bg-gradient-to-br from-black/85 via-gray-900/80 to-black/85"></div>
  ...
  <div className="absolute inset-0 pointer-events-none opacity-30">
    <motion.div
      className="absolute top-20 left-10 w-48 h-48 md:w-64 md:h-64 bg-primary/20 rounded-full blur-3xl"
      animate={{
        scale: [1, 1.3, 1],
        opacity: [0.3, 0.5, 0.3],
      }}
    ...
    />
    <motion.div
      className="absolute bottom-20 right-10 w-56 h-56 md:w-72 md:h-72 bg-secondary/20 rounded-full blur-3xl"
      animate={{
        scale: [1, 1.4, 1],
        opacity: [0.3, 0.5, 0.3],
      }}
  ...
  {/* Content */}
  <div className="relative z-10 w-full text-white py-20 px-4">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-duration={1000}>
          ...
          >
            ...
            >
              <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-xl">
                <img
                  src={country.image || "/placeholder.jpg"}
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-xl pt-14 pb-8 px-6 text-center shadow-2xl hover:shadow-primary/20 transition-all duration-300 group">
              <h3 className="text-gray-900 text-xl font-bold mb-3 group-hover:text-primary transition-colors">
                {country.name}
              </h3>
              ...
              <motion.div 
                className="mt-4 h-1 bg-gradient-to-r from-primary via-secondary to-accent rounded-full mx-auto"
                initial={{ width: 0 }}
     ...
     <div className="max-w-6xl mx-auto px-4 py-16"  data-aos="fade-up" data-aos-duration={1400}>
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold">
          4 Step Follow You Can Get <br className="hidden md:block" />
          Your Visa Easily
        </h2>
      </div>
  ...
  <div className="container px-6 py-10 mx-auto" >
    <div className="lg:flex lg:items-center">
      <div className="w-full space-y-12 lg:w-1/2">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-blue-600 capitalize lg:text-3xl dark:text-blue-400">
