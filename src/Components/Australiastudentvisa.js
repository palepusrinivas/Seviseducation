...
const Australiastudentvisa = () => {
  ...
  const keyAdvantages = [
    ...
    "Commitment to Excellence in Education and Training",
        ...
        <AnimatePresence mode="wait">
          ...
          {activeCategory === "REQUIRED DOCUMENTS" && (
            ...
            >
              ...
              {/* CoE Information */}
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-12 mb-16" data-aos="fade-up">
          ...
          {activeCategory === "ADMISSION REQUIREMENTS" && (
            ...
            >
              ...
              <div className="bg-blue-50 border-l-4 border-primary rounded-r-xl p-6 mb-8" data-aos="fade-up">
                <h3 className="font-bold text-gray-900 mb-3 text-lg">📚 Important Information:</h3>
          ...
          {activeCategory === "VISA REQUIREMENTS" && (
            ...
            >
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-6 border-2 border-primary/20 mb-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Processing Time & Fees:</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-700">Visa Application Fee:</span>
                        <span className="font-bold text-primary">AUD 650</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-700">Processing Time:</span>
                        <span className="font-bold text-secondary">29-79 days (average)</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-700">Visa Validity:</span>
                        <span className="font-bold text-gray-900">Course duration + extra time</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
              ...
              {/* GTE Statement */}
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-12 mb-12" data-aos="fade-up">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Genuine Temporary Entrant (GTE) Statement
                </h2>
                <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-xl p-6 shadow-md">
                    <h4 className="font-bold text-gray-900 mb-3">What to Include:</h4>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-md">
                    <h4 className="font-bold text-gray-900 mb-3">Key Points to Address:</h4>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
              ...
              <div className="bg-blue-50 border-l-4 border-primary rounded-r-xl p-6" data-aos="fade-up">
                <h3 className="font-bold text-gray-900 mb-3 text-lg">🔗 Official Resources:</h3>
                <p className="text-gray-700 mb-4">
